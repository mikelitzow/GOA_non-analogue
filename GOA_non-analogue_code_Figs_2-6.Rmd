...
mtext("Non-analog models", col="#56B4E9", adj=0.15, line=0.6, outer=T)
mtext("Analog models", col="#D55E00", adj=0.135, line=-0.8, outer=T)

par(mar=c(7,3,2,0.5))
plot(data$year, resid(mod), type="o", pch=19, col="#D55E00", ylab="Residual", xlab="")
abline(h=0)
